              ...
              <Grid item xs={5}>
                <Box className={classes.landingContent}>
                  <Box>
                    ...
                    <Typography variant="h3">Cho tương lai của bạn</Typography>
                  </Box>
            ...
            <Grid item xs={6}>
              <Box className={classes.founderTextBox}>
                ...
                <Typography variant="body1">
                  ...
                  menu featuring items like Banh Mi, a flavorful sandwich staple
                  from Vietnam, and the classic American Burger.
                </Typography>
                <Box
                  sx={{
                    display: "flex",
